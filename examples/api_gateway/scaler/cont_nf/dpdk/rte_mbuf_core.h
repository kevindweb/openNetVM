...
#define PKT_TX_OFFLOAD_MASK                                                                                            \
        (PKT_TX_OUTER_IPV6 | PKT_TX_OUTER_IPV4 | PKT_TX_OUTER_IP_CKSUM | PKT_TX_VLAN_PKT | PKT_TX_IPV6 | PKT_TX_IPV4 | \
         PKT_TX_IP_CKSUM | PKT_TX_L4_MASK | PKT_TX_IEEE1588_TMST | PKT_TX_TCP_SEG | PKT_TX_QINQ_PKT |                  \
         PKT_TX_TUNNEL_MASK | PKT_TX_MACSEC | PKT_TX_SEC_OFFLOAD | PKT_TX_UDP_SEG | PKT_TX_OUTER_UDP_CKSUM)
...
enum {
        ...
        RTE_MBUF_TXOFLD_UNUSED_BITS = sizeof(uint64_t) * CHAR_BIT - RTE_MBUF_L2_LEN_BITS - RTE_MBUF_L3_LEN_BITS -
                                      RTE_MBUF_L4_LEN_BITS - RTE_MBUF_TSO_SEGSZ_BITS - RTE_MBUF_OUTL3_LEN_BITS -
        ...
        RTE_MBUF_OUTL3_LEN_OFS = RTE_MBUF_TSO_SEGSZ_OFS - RTE_MBUF_OUTL3_LEN_BITS,
        RTE_MBUF_OUTL2_LEN_OFS = RTE_MBUF_OUTL3_LEN_OFS - RTE_MBUF_OUTL2_LEN_BITS,
        RTE_MBUF_TXOFLD_UNUSED_OFS = RTE_MBUF_OUTL2_LEN_OFS - RTE_MBUF_TXOFLD_UNUSED_BITS,
#else
        ...
        RTE_MBUF_TXOFLD_UNUSED_OFS = RTE_MBUF_OUTL2_LEN_OFS + RTE_MBUF_OUTL2_LEN_BITS,
#endif
};
