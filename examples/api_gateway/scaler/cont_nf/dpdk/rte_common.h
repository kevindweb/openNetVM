 ...
 */
#if RTE_CC_IS_GNU
#define __rte_format_printf(format_index, first_arg) __attribute__((format(gnu_printf, format_index, first_arg)))
#else
...
#define container_of(ptr, type, member)                               \
        __extension__({                                               \
                ...
                __rte_unused type *_target_ptr = (type *)(ptr);       \
 ...
 */
__rte_noreturn void
rte_exit(int exit_code, const char *format, ...) __rte_format_printf(2, 3);
